########################################################
#Script_in vldb12/GoasdoueKLM11
verified=true
sent=true
...
-subject "Your VLDB'11 paper" -cc 'konstantinos.karanasos@inria.fr,julien.leblay@inria.fr,ioana.manolescu@inria.fr' \
'francois.goasdoue@inria.fr'
echo "EXIT_CODE $?"
########################################################