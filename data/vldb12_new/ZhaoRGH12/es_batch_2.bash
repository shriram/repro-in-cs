########################################################
#Script_in vldb12_new/ZhaoRGH12
verified=true
sent=true
...
IQUOTEve been looking at your VLDBQUOTE12 paper
   A Bayesian Approach to Discovering Truth from Conflicting
...
-subject "Your VLDB'12 paper" -cc 'hanj@illinois.edu,ben.rubinstein@microsoft.com,jim.gemmell@microsoft.com' \
'bozhao3@illinois.edu'
echo "EXIT_CODE $?"
########################################################