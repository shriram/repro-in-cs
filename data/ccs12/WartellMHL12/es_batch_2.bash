...
-subject "Your CCS'12 paper" -cc 'vishwath.mohan@utdallas.edu,hamlen@utdallas.edu,zhiqiang.lin@utdallas.edu' \
'richard.wartell@utdallas.edu'
echo "EXIT_CODE $?"
########################################################