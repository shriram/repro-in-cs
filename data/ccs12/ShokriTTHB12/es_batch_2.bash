...
IQUOTEve been looking at your CCSQUOTE12 paper
   Protecting location privacy: optimal strategy against
...
-subject "Your CCS'12 paper" -cc 'jean-pierre.hubaux@epfl.ch,jean-yves.leboudec@epfl.ch,g.theodorakopoulos@cs.cardiff.ac.uk,carmela.troncoso@esat.kuleuven.be' \
'reza.shokri@epfl.ch'
echo "EXIT_CODE $?"
########################################################