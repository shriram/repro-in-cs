########################################################
#Script_in oopsla12/Effinger-DeanLCGB12
verified=true
sent=true
...
-subject "Your OOPSLA'12 paper" -cc 'blucia0a@cs.washington.edu,luisceze@cs.washington.edu,djg@cs.washington.edu,hans.boehm@hp.com' \
