...
IQUOTEve been looking at your OOPSLAQUOTE12 paper
   Molecule: using monadic and streaming I/O to compose
...
-subject "Your OOPSLA'12 paper" -cc 'koen.daenen@alcatel-lucent.com' \
'sebastien.bocq@alcatel-lucent.com'
echo "EXIT_CODE $?"
########################################################
