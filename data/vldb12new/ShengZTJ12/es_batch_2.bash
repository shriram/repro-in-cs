########################################################
#Script_in vldb12_new/ShengZTJ12
verified=true
sent=true
...
IQUOTEve been looking at your VLDBQUOTE12 paper
   Optimal Algorithms for Crawling a Hidden Database in
   the Web
...
-subject "Your VLDB'12 paper" -cc 'taoyf@cse.cuhk.edu.hk,taoyf@kaist.ac.kr,nzhang10@gwu.edu,xjin@gwmail.gwu.edu' \
