########################################################
#Script_in sosp11/ColpNZACDLW11
verified=true
sent=true
...
IQUOTEve been looking at your SOSPQUOTE11 paper
   Breaking up is hard to do: security and functionality
...
-subject "Your SOSP'11 paper" -cc 'andy@cs.ubc.ca' \
'pjcolp@cs.ubc.ca'
echo "EXIT_CODE $?"
########################################################