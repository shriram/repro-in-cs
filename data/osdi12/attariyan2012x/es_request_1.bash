########################################################
#Script_in osdi12/attariyan2012x
verified=true
sent=true
...
IQUOTEve been looking at your OSDIQUOTE12 paper
   X-ray: automating root-cause diagnosis of performance
...
-subject "Your OSDI'12 paper" -cc 'mcchow@umich.edu,jflinn@umich.edu' \
'monattar@nameofcompany.com'
echo "EXIT_CODE $?"
########################################################